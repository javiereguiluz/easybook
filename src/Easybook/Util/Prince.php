...
final class Prince
{
    ...
    public function addStyleSheet($cssPath): void
    {
    ...
    public function addScript($jsPath): void
    {
        $this->scripts .= '--script "' . $jsPath . '" ';
    }

    // Clear all of the scripts.
    public function clearScripts(): void
    {
        $this->scripts = '';
    }
    ...
    public function addFileAttachment($filePath): void
    {
        $this->fileAttachments .= '--attach=' . '"' . $filePath . '" ';
    }

    // Clear all of the file attachments.
    public function clearFileAttachments(): void
    {
    ...
    public function setLicenseFile($file): void
    {
    ...
    // key: The license key
    public function setLicenseKey($key): void
    {
        $this->licenseKey = $key;
    }
    ...
    public function setJavaScript($js): void
    {
        $this->javascript = $js;
    }
    ...
    public function setLog($logFile): void
    {
    ...
    public function setXInclude($xinclude): void
    {
    ...
    public function setHttpUser($user): void
    {
    ...
    public function setHttpPassword($password): void
    {
    ...
    public function setFileRoot($fileRoot): void
    {
    ...
    public function setEmbedFonts($embedFonts): void
    {
    ...
    public function setSubsetFonts($subsetFonts): void
    {
    ...
    public function setArtificialFonts($artificialFonts): void
    {
    ...
    public function setEncryptInfo(
        ...
        if ($keyBits !== 40 && $keyBits !== 128) {
            throw new Exception("Invalid value for keyBits: ${keyBits}" . ' (must be 40 or 128)');
        }
    ...
    public function convert_file($xmlPath, &$msgs = [])
    {
    ...
    // msgs: An optional array in which to return error and warning messages.
    // Returns true if a PDF file was generated successfully.
    public function convert_file_to_file($xmlPath, $pdfPath, &$msgs = [])
    {
        $pathAndArgs = $this->getCommandLine();
    ...
    // msgs: An optional array in which to return error and warning messages.
    // Returns true if a PDF file was generated successfully.
    public function convert_multiple_files($xmlPaths, $pdfPath, &$msgs = [])
    {
        $pathAndArgs = $this->getCommandLine();
    ...
    // msgs: An optional array in which to return error and warning messages.
    // Returns true if a PDF file was generated successfully.
    public function convert_string_to_file($xmlString, $pdfPath, &$msgs = [])
    {
        $pathAndArgs = $this->getCommandLine();
        $pathAndArgs .= ' - -o "' . $pdfPath . '"';
    ...
    public function convert1($xmlPath, &$msgs = [])
    {
        return $this->convert_file($xmlPath, $msgs);
    }

    // Old name for backwards compatibility
    public function convert2($xmlPath, $pdfPath, &$msgs = [])
    {
